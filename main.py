...
def main():
    ...
    if not data_path.exists():
        ...
        df = load_data(data_path, config['data']['date_column'], 
                  config['data']['value_column'], config['data']['frequency'])
        ...
        save_forecast_plot(test_data, forecasts, config['model']['context_length'],
